      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
                ...
                Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(9.92.r)),
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(47.0, 8.0, 52.0, 0.0),
              child: Text(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                      onPressed: () =>
                          AppNavigator.push(context, AppRoutes.signUpScreen),
